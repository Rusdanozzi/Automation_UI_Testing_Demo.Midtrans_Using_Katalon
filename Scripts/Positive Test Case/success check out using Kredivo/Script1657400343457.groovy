...
WebUI.setText(findTestObject('Kredivo/input phone number'), '081123123123')

WebUI.setText(findTestObject('Kredivo/input pin'), '123456')

WebUI.click(findTestObject('Kredivo/select installment Term'))

WebUI.click(findTestObject('Kredivo/Text installment term 30 days'))

WebUI.click(findTestObject('Kredivo/select installment Term'))

WebUI.click(findTestObject('Kredivo/Text installment term 3 months'))

WebUI.click(findTestObject('Kredivo/select installment Term'))

WebUI.click(findTestObject('Kredivo/Text installment term 6 months'))

WebUI.click(findTestObject('Kredivo/select installment Term'))

WebUI.click(findTestObject('Kredivo/Text installment term 12 months'))
...
WebUI.verifyElementText(findTestObject('Kredivo/text Transaction is Successful'), 'Transaction is Successful')
