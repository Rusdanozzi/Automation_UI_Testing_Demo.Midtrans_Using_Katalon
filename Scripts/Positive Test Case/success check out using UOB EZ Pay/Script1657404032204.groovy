...
WebUI.click(findTestObject('UOB/button UOB'))
...
WebUI.click(findTestObject('UOB/button bayar'))

WebUI.switchToWindowUrl('https://simulator.sandbox.midtrans.com/uob/ezpay/payment')

WebUI.verifyElementText(findTestObject('UOB/text transaksi sukses'), 'Transaksi Sukses')
