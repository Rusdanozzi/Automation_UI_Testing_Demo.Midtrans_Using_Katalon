...
WebUI.click(findTestObject('Credit card/button pay now disable'))

WebUI.verifyElementText(findTestObject('Credit card/text CVV cant be empty'), 'CVV can\'t be empty.')

WebUI.verifyElementText(findTestObject('Credit card/text Expiry cant be empty'), 'Expiry can\'t be empty.')
