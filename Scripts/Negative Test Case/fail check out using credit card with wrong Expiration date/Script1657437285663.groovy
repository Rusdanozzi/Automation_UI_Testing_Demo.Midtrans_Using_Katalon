...
WebUI.setText(findTestObject('Credit card/Input Expiration Date'), '0421')

WebUI.setText(findTestObject('Credit card/Input Card CVV'), '123')

WebUI.verifyElementText(findTestObject('Credit card/text Invalid expiration detail'), 'Invalid expiration detail.')
