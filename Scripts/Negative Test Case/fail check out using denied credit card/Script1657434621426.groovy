...
WebUI.setText(findTestObject('Credit card/Input Card number'), '4811111111111113')
...
WebUI.verifyElementText(findTestObject('Credit card/Text Make sure your card number are correct'), 'Make sure your card number are correct.')
