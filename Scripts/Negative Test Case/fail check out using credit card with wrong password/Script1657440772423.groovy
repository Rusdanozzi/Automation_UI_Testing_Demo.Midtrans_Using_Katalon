...
WebUI.setText(findTestObject('Credit card/Input Password in Issuing Bank'), '332211')
...
WebUI.verifyElementText(findTestObject('Credit card/text card declined by bank'), 'Card declined by bank')

WebUI.click(findTestObject('Credit card/button OK in Card declined'))
